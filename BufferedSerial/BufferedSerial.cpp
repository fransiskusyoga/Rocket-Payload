...
{
    return _rxbuf.available();  // return amount of charracter in _rxbuf
}

int BufferedSerial::writeable(void)
{
    return (_buf_size*_tx_multiple - _txbuf.available());   // return amount of available space in _txbuff
}
